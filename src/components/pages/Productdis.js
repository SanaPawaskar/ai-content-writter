...
function  Productdis() {
  const [isLoading, setIsLoading] = useState(false);
    ...
    openai.createCompletion( {
        ...
        prompt: `write creative,impactfull,meaningfull and concise product description for the given product  ${topic}`,
        temperature: 1,
        max_tokens: 500,
        top_p: 1,
        frequency_penalty: 0,
  ...
  return (
    ...
    <label className='enter-topic-div'>Enter your topic:
     <br></br> <input  className='input-text-area_content'
        type="text" 
        placeholder="enter the product name or description to get product description "
        value={topic}
