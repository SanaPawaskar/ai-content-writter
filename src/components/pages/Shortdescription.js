...
function  Shortdescription() {
  const [isLoading, setIsLoading] = useState(false);
    ...
    openai.createCompletion( {
        ...
        prompt: `write a catchy concised,short and to the point description,At a minimum should be at least 150 characters long for the given topic ${topic}`,
        temperature: 1,
        max_tokens:100,
        top_p: 1,
        frequency_penalty: 0,
  ...
  return (
    ...
    <label className='enter-topic-div'>Enter your topic:
     <br></br> <input  className='input-text-area_content'
        type="text" 
        placeholder="Enter a topic to get short description on it eg. HRMS"
        value={topic}
